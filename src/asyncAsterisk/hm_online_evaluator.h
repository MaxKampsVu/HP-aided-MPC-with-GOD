...
namespace hmAsyncAsterisk {
    ...
    class OnlineEvaluator {
        ...
        std::vector<AuthShamirShare<Field>> q_sh_;
        ...
        void evaluateGatesAtDepthPartySend(size_t depth, std::vector<Field> &mult_nonTP, std::vector<Field> &r_mult_pad);
        void evaluateGatesAtDepthPartyRecv(size_t depth, std::vector<Field> mult_all, std::vector<Field> r_mult_pad);
